...
## TypeScrip 적용
동적 타입 언어인 TypeScript를 프로젝트에 적용중입니다. TypeScript는 런타임 시점이 아닌 컴파일 타임에 오류를 잡아낼 수 있습니다.
사용하는 데이터에 타입을 부여하기 떄문에 코드를 작성할 때, 리팩토링을 진행할 때, 그리고 다른 사람과의 작업을 진행할 때 코드를 이해하기 쉬워진다는 장점도 있을 것이라 예상됩니다.
