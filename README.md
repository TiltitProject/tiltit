...
- [💻 Development](#-development)
  * [1. Gyroscope의 값으로 캐릭터를 어떻게 이동시킬 수 있을까?](#1-gyroscope--------------------------)
  * [2. 하드코딩 하지 않고 맵을 구현하는 방법은 없을까?](#2----------------------------)
    + [2.1 문제점: 하드코딩으로 맵을 만드는건 한계가 있다.](#21---------------------------)
    + [2.2 아이디어: 구글 스프레드 시트를 활용하자.](#22-----------------------)
    + [2.3 구현과정: 'col'과 'row'의 값을 요소의 크기와 좌표로 변환하자.](#23--------col----row----------------------)
