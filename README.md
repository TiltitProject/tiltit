...
- 🛠️ Optimization
  ...
  + audio effect가 메모리 누수를 발생시키고 있었다.
- 🎞️ Animation
  + 애니메이션으로 fade-in/out 효과를 주어 화면 전환을 부드럽게!
  + png 이미지를 동적으로 바꾸어 캐릭터 컴포넌트를 생동감 있게 표현하자
  + 캐릭터가 몬스터와 충돌 시, 몬스터가 무적 캐릭터와 충돌 시 애니메이션 효과를 주자!
...
<스프레드시트에 입력된 맵의 정보>
<br>
<img width="500" alt="image" src="https://github.com/TiltitProject/tiltit/assets/106131005/aee74d81-7e47-4a7d-8096-7249e465d28a.png">
...
남은건 이 데이터를 순회하며 entity들의 컴포넌트를 생성하는 유틸 함수를 호출하는 것입니다.
