...
- [💻 Development](#---development)
  ...
  * [2. 맵의 entity(미로, 아이템, 몬스터 등)의 좌표와 크기 정보를 선언적으로 얻을 수 있는 방법은 없을까?](#2----entity---------------------------------------------------)
- 🛠️ Optimization
  + 한번에 너무 많은 컴포넌트를 렌더링 시키지 말자.
...
스프레드 시트의 맵 정보를 정확히 게임에 반영할 수 있었기에 뷰포트에 보이지 않는 맵을 디자인 할 수 있었습니다.
